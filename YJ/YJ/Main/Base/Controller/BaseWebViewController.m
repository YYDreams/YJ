...
- (UIWebView*)webView
{
    if (!_webView)
    {
        _webView = [[UIWebView alloc]initWithFrame:CGRectMake(0,TOP_MARGIN, kScreenWidth, kScreenHeight-TOP_MARGIN-(self.isNeedNavBar?64:0))];
...
- (WKWebView * )wkWebView
{
    if (!_wkWebView)
    {
        ...
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0,TOP_MARGIN, kScreenWidth,kScreenHeight-TOP_MARGIN-(self.isNeedNavBar?64:0)) configuration:configuretion];
